...
import it.uniba.di.cdg.xcore._1to1.ChatManager.IChatStatusListener;
import it.uniba.di.cdg.xcore._1to1.IChatService.ChatContext;
...
public class ChatPlugin extends Plugin implements IBackendEventListener {
	 ...
	 * Plug-in id.
	 */
	public static final String ID = "it.uniba.di.cdg.xcore._1to1";
	...
	public void openChatWindow(ChatContext chatContext) {
		...
		chat.addChatStatusListener(new IChatStatusListener() {
			 ...
			 * 
			 * @see
			 * it.uniba.di.cdg.xcore._1to1.ui.Chat.IChatStatusListener#closed
			 * (it.uniba.di.cdg.xcore._1to1.ui.Chat)
			 */
			 ...
			 * 
			 * @see
			 * it.uniba.di.cdg.xcore._1to1.ui.Chat.IChatStatusListener#open(it

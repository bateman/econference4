...
public class MoveUp extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		String upText = ((IDiscussionItem) getModel().getItemList().getItem(threadId-1)).getText();
		
		
        ((IDiscussionItem) getModel().getItemList().getItem(threadId)).setText(upText);

...
public class AgendaCommandState extends AbstractSourceProvider {
	public final static String MY_STATE = "it.uniba.di.cdg.xcore.econference.sourceprovider.active";
	...
	public void toogleEnabled(Boolean roleModerator) {
		
		String value = roleModerator ? ENABLED : DISENABLED;

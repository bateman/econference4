...
public class RichFormatting implements FormatListener {
	...
	public RichFormatting(
			List<AbstractMarkerPattern<TextStyleRange>> pattern_markup) {
	...
	public static AbstractMarkerPattern<TextStyleRange> UNDERLINE_MARKER = new AbstractMarkerPattern<TextStyleRange>(
			"__") {
		@Override
	...
	public static AbstractMarkerPattern<TextStyleRange> BOLD_UNDERLINE_MARKER = new AbstractMarkerPattern<TextStyleRange>(
			"*_*_") {
		@Override
		public TextStyleRange apply(TextStyleRange obj) {
			obj.fontStyle = SWT.BOLD;
	...
	public static AbstractMarkerPattern<TextStyleRange> _NO_MARKER = new AbstractMarkerPattern<TextStyleRange>(
			"_NO_") {
		@Override
		public TextStyleRange apply(TextStyleRange obj) {
			final Device device = Display.getCurrent();
